...
class SwapCreatedEvent extends NetEvent {
    constructor(
        ...
        const data: BytesWriter = new BytesWriter(
            U256_BYTE_LENGTH * 7 + ADDRESS_BYTE_LENGTH,
        );
...
export class SwapVault extends OP_NET {
    ...
    public createSwap(calldata: Calldata): BytesWriter {
        ...
        TransferHelper.transferFrom(this._moto(), depositor, Blockchain.contractAddress, amount);
    ...
    public claim(calldata: Calldata): BytesWriter {
        ...
        // Interaction: transfer MOTO to counterparty
        TransferHelper.transfer(this._moto(), counterparty, amount);
    ...
    // raw 32-byte hash: fd447384 0751d58d 9f8b73bd d57d6c52 60453d55 18bd7cd0 2d0a4cf3 df9bf4dd
